...
namespace RhinoPlugInExcercise1
{
    ...
    public class ArStudyOnCirclesAxesV2 : AbsCommand
    {
        public ArStudyOnCirclesAxesV2()
        {
            Instance = this;
        }
        ...
        public override string EnglishName => "ArStudyOnCirclesAxesV2";

        public static ArStudyOnCirclesAxesV2 Instance { get; private set; }
    }
}
