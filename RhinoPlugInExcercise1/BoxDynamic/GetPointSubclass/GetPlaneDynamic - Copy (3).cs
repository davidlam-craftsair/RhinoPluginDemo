...
namespace RhinoPlugInExcercise1
{
    public class GetPlaneDynamic: GetPoint
    {
        ...
        protected override void OnMouseDown(GetPointMouseEventArgs e)
        {
            ...
            //    case 3: MouseDownIteration3(e); break;
            //    default:
            //        break;
            //}
        ...
        private void MouseDownIteration2(GetPointMouseEventArgs e)
        {
            if (e.ShiftKeyDown)
            {
                // Override the value of corner2Tmp from DynamicDraw
                SetCorner2TmpToOffsetDistances(e);
            }
            else
            {
                SetCorner2TmpByCurrentPt(e);
            }
        ...
        private void SetCorner2TmpByCurrentPt(GetPointMouseEventArgs e)
        {
            corner2Tmp = CPlane1.ClosestPoint(e.Point);
        }
        ...
        #endregion
        private void SetCorner2TmpToOffsetDistances(GetPointMouseEventArgs e)
        {
            if (GetOffsetDistances(out double t1, out double t2))
            {
        ...
        {
            BoxCreation.BaseCorner2 = corner2Tmp;
        }
        ...
        {
            return OffsetDistancesGetter.Get(out dx, out dy);
        }
