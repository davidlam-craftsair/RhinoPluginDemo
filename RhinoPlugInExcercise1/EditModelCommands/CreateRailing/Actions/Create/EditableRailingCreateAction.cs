...
{
    /// <summary>
    /// Compared to v1, this uses IComponentsToSessionAdderV2 to create Railing
    /// </summary>
    public class EditableRailingCreateAction : IEditableSweepCreateAction
    {
        public EditableRailingCreateAction(IDocManager docManager,
        ...
        public Result Create(ObjRef railObj, IEnumerable<ObjRef> profileObjs)
        {
            ...
            // Create breps from rail and profiles
