...
{
    public class FloorBoundaryCloseEditActionV3 : IFloorBoundaryCloseEditAction
    {
        public FloorBoundaryCloseEditActionV3(IDocManager docManager,
        ...
        {
            var b = DocManager.RhinoDoc.Get(GetEdgeIds(rhinoFloorUpdateInfo), out IEnumerable<Curve> existingEdges);
            if (b)
            {
